<template>
  ...
  export default {
    data() {
      return {
        showAddReasonButton: false, // Controls visibility of the "+" button
    ...
    methods: {
      rejectAppointment() {
        // Simulate rejecting an appointment
        this.$q.notify({
          type: 'negative',
        ...
        // Show the "+" button for adding a reason
        this.showAddReasonButton = true;
      },
      closeReasonDialog() {
      ...
      submitReason() {
        ...
        this.showAddReasonButton = false; // Optionally hide the "+" button after submission
      },
    },
  };
  </script>
